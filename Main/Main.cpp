...
int main() {
    ...
    string CreatorPath = "F:\\Projects\\Lab1OS\\Creator\\x64\\Debug\\Creator.exe";
    ...
    if (CreateProcessA(CreatorPath.c_str(), cmdLine.data(), NULL, NULL, FALSE,
        CREATE_NEW_CONSOLE, NULL, NULL, &cr, &startCreator)) {
        ...
        while (outTemp.readBinary(binf)) {
            outTemp.readBinary(binf);
            cout << outTemp << endl;
        }
    }
    else {
    ...
    string ReporterPath = "F:\\Projects\\Lab1OS\\Reporter\\x64\\Debug\\Reporter.exe";
    ...
    if (CreateProcessA(ReporterPath.c_str(), cmdLine.data(), NULL, NULL, FALSE,
        CREATE_NEW_CONSOLE, NULL, NULL, &rep, &startReporter)) {
